...
## What I’m working on
- Building **Splita**
- Contributing to **AI system evaluation and reliability**
- Working on **authentication infrastructure, PKI, and FIDO2**
- Growing as a software engineer, founder, and product builder
...
- Deepening my understanding of AI and secure systems
- Building technical and founder leverage early

## Experience
- **Co-Founder & CEO** — Splita  
- **AI DevOps Contractor** — Snorkel AI  
- **Software Engineering** — Queralt Inc.  
- **CS Student** — Trinity College
